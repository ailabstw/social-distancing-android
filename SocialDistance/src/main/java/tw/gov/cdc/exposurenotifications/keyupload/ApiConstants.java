...
public class ApiConstants {
    ...
    /**
     * Consts for the second version of the keyserver exposurenotifications.api, called "v1". The first API version is
    ...
    public static class UploadV1 {
        ...
        public static final String HEALTH_AUTHORITY_ID = "healthAuthorityID";
    ...
    /**
     * Consts for the first version of the verification server exposurenotifications.api.
     */
