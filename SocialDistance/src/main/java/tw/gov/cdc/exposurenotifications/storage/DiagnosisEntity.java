 ...
 *
 * <p>Partners should implement a daily TTL/expiry, for on-device exposurenotifications.storage of this data, and must
 * ensure compliance with all applicable laws and requirements with respect to encryption, exposurenotifications.storage,
